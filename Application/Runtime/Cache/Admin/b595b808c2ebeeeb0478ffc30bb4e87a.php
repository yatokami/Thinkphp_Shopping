        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo ($goods_active); ?> treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo ($goods_update_active); ?>"><a href="#"><i class="fa fa-circle-o"></i>修改商品信息</a></li>
                    <li class="<?php echo ($goods_select_active); ?>"><a href="#"><i class="fa fa-circle-o"></i>查询商品信息</a></li>
