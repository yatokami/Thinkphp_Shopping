                                ...
                                <form action="<?php echo U('Index/good');?>" method="get">
                                    <div class="col-sm-6">
                                        <div id="example1_filter" class="dataTables_filter">
                                            ...
                                            <label>根据商品名查询:<input id="searchtxt" name="GoodsName" type="search" class="form-control input-sm" placeholder="" aria-controls="example1"></label><button id="search" type="submit" class="btn btn-block btn-info" style="width:70px;">查询</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php if(is_array($data["goods"])): $i = 0; $__LIST__ = $data["goods"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr role="row" class="odd">
                                            ...
                                            <td><img style="height:100px; width:100px" class="img-responsive img-rounded" src="/Public/images/<?php echo ($vo["type_id"]); ?>/<?php echo ($vo["goods_imgsrc"]); ?>" /></td>
